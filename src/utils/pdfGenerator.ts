...
const translations = {
  ro: {
    ...
    cui: "CUI:",
    regCom: "Reg. Com:",
    stornoReference: "Storno pentru factura:"
  },
  en: {
    invoice: "INVOICE",
    proforma: "PROFORMA",
    ...
    cui: "Tax ID:",
    regCom: "Reg. No:",
    stornoReference: "Credit note for invoice:"
  }
};
...
export const generateInvoicePDF = (
  ...
  // Document title
  let documentTitle = t.invoice;
  if (invoice.invoice_type === "proforma") {
    documentTitle = t.proforma;
  } else if (invoice.invoice_type === "storno") {
    documentTitle = t.storno;
  }
  doc.setFontSize(24);
